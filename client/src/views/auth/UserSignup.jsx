...
function UserSignup() {
  ...
  return (
    <AuthFormCard title="User Signup" onSubmit={handleSubmit}>
      <Box type="text" name="name" placeholder="Full Name" value={formData.name} onChange={handleChange} />
      ...
      <SignupButton text={loading ? "Signing up..." : "Create Account"} disabled={loading} />
